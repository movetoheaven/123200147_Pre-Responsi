            ...
            return SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(width: 80, height: 80,child: Expanded(child: Image.network('https://api.genshin.dev/characters/${data.name}/talent-${data.skillTalents}'))),
                  ...
                  Row(
                    children: [
                      Container(width: 80, height: 80,child: Expanded(child: Image.network('https://api.genshin.dev/characters/${data.name}/talent-${data.skillTalents}'))),
                      Expanded(child: Text(data.skillTalents[1].description, textAlign: TextAlign.justify,))
                    ],
                  ),
                  SizedBox(height: 30,),
                  Row(
                    children: [
                      Container(width: 80, height: 80,child: Expanded(child: Image.network('https://api.genshin.dev/characters/${data.name}/talent-${data.skillTalents}'))),
                      Expanded(child: Text(data.skillTalents[2].description, textAlign: TextAlign.justify,))
                    ],
                  ),
                ],
              ),
