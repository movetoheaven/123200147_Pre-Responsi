...
//
//     final detailCharacters = detailCharactersFromJson(jsonString);

import 'dart:convert';

DetailCharacters detailCharactersFromJson(String str) => DetailCharacters.fromJson(json.decode(str));

String detailCharactersToJson(DetailCharacters data) => json.encode(data.toJson());

class DetailCharacters {
    String name;
    String title;
    String vision;
    String weapon;
    ...
    factory DetailCharacters.fromJson(Map<String, dynamic> json) => DetailCharacters(
        name: json["name"],
        title: json["title"],
        vision: json["vision"],
        weapon: json["weapon"],
        ...
        skillTalents: List<Constellation>.from(json["skillTalents"].map((x) => Constellation.fromJson(x))),
